...
Detalle de cada archivo: [Wiki → Detalle del dataset](https://github.com/kaneeqi/CC219-TP-TF-2026-1-CC92/wiki/Detalle-del-dataset)
...
Detalle completo de la validación y las correcciones aplicadas: [Wiki → Detalle de mejoras](https://github.com/kaneeqi/CC219-TP-TF-2026-1-CC92/wiki/Detalle-de-mejoras)
...
* [Wiki del proyecto](https://github.com/kaneeqi/CC219-TP-TF-2026-1-CC92/wiki) (estructura del código, detalle del dataset, detalle de mejoras)
